...
function img_change(myDiv){
    ...
    categories_images.push(document.getElementById(myDiv).style.backgroundImage.slice(23,-2));
    document.getElementById(myDiv).style.backgroundImage = "url({{ url_for('static', filename='PORTFOLIO/" + first_element + "') }})";
}
